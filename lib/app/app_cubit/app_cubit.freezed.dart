...
mixin _$AppState {
  ...
  Result map<Result extends Object>({
    ...
    @required Result loading(_AppLoadingState value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result loading(_AppLoadingState value),
...
class __$AppLoadingStateCopyWithImpl<$Res> extends _$AppStateCopyWithImpl<$Res>
...
class _$_AppLoadingState implements _AppLoadingState {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _AppLoadingState);
  }
...
abstract class _AppLoadingState implements AppState {
  const factory _AppLoadingState() = _$_AppLoadingState;
}
...
class _$_AppErrorState implements _AppErrorState {
  const _$_AppErrorState({this.msg});
